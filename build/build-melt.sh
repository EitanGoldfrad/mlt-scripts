...
function set_globals {
  ...
  REPOLOCS[3]="https://git.videolan.org/git/x264"
  ...
  #####
  # ffmpeg
  CONFIG[0]="./configure --prefix=$FINAL_INSTALL_DIR --enable-gpl --enable-libfribidi --enable-libspeex --enable-libfreetype --enable-librtmp --enable-gnutls --enable-version3 --enable-shared --enable-debug --enable-pthreads --enable-runtime-cpudetect"
  ...
  ####
  # x264
  CONFIG[3]="./configure --prefix=$FINAL_INSTALL_DIR --enable-shared --disable-asm"
  CFLAGS_[3]=$CFLAGS
